...
<div id="my_play_area">
    ...
    <div id="board">
        ...
        <div class="point_tokens" style="grid-area: 1/2/2/3"><span id="point_token_6_counter">0x</span><div id="points_6" class="point_token point_token_6"></div></div>
        ...
        <div class="point_tokens" style="grid-area: 1/3/2/4"><span id="point_token_7_counter">0x</span><div id="points_7" class="point_token point_token_7"></div></div>
        ...
        <div class="point_tokens" style="grid-area: 1/4/2/5"><span id="point_token_8_counter">0x</span><div id="points_8" class="point_token point_token_8"></div></div>
        ...
        <div class="point_tokens" style="grid-area: 1/5/2/6"><span id="point_token_9_counter">0x</span><div id="points_9" class="point_token point_token_9"></div></div>
        ...
        <div class="point_tokens" style="grid-area: 1/6/2/7"><span id="point_token_10_counter">0x</span><div id="points_10" class="point_token point_token_10"></div></div>
