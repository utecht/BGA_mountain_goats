...
<div id="board">
    ...
    <div id="goat_start_5" class="goat_start" style="grid-area: 5 / 3 / 6 / 4"></div>
    ...
    <div id="goat_start_5" class="goat_start" style="grid-area: 5 / 4 / 6 / 5"></div>
    ...
    <div id="goat_start_5" class="goat_start" style="grid-area: 4 / 5 / 5 / 6"></div>
    ...
    <div id="goat_start_5" class="goat_start" style="grid-area: 4 / 6 / 5 / 7"></div>
